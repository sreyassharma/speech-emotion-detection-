...
# load models
model = load_model("C:/Users/s4sre/Desktop/FINAL_PROJECT/Junk_Files/speech-emotion-webapp-master/model3.h5")
...
def main():
    side_img = Image.open("C:/Users/s4sre/Desktop/FINAL_PROJECT/Junk_Files/speech-emotion-webapp-master/images/emotion3.jpg")
    with st.sidebar:
        st.image(side_img, width=300)
    st.sidebar.subheader("Speech Emotion Recognition")
        ...
        if audio_file is not None:
            ...
            if model_type == "mfccs":
                ...
                with st.container():
                    ...
                    with col3:
                        if em7:
                            model_ = load_model("C:/Users/s4sre/Desktop/FINAL_PROJECT/Junk_Files/speech-emotion-webapp-master/model4.h5")
                    ...
                    with col4:
                        if gender:
                            with st.spinner('Wait for it...'):
                                gmodel = load_model("C:/Users/s4sre/Desktop/FINAL_PROJECT/Junk_Files/speech-emotion-webapp-master/model_mw.h5")
                                ...
                                img = Image.open("C:/Users/s4sre/Desktop/FINAL_PROJECT/Junk_Files/speech-emotion-webapp-master/images/" + gdict[ind][1])
